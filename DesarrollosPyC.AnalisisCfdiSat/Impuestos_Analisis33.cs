...
namespace DesarrollosPyC.AnalisisCfdiSat
{
    ...
    /// </summary>
    public class Impuestos_Analisis33
    {
        ...
        /// </summary>
        public Dictionary<DesarrollosPyC.Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal> Impuesto_Concepto { get; private set; }

        /// <summary>
        /// Constructor de la clase
        /// </summary>
        public Impuestos_Analisis33()
        {
            Impuesto_Concepto = new Dictionary<DesarrollosPyC.Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal>();
        }
        ...
        public void AddConceptos(List<DesarrollosPyC.Com.Facturacion.Comprobantes.V33.ComprobanteConcepto> conceptos)
        {
            if (Subtotal == decimal.Zero)
                return;

            // Genera proporciones de conceptos
            Dictionary<DesarrollosPyC.Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal> proporciones = new Dictionary<Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal>();
            ...
            Dictionary<Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal> addings = new Dictionary<Com.Facturacion.Comprobantes.V33.ComprobanteConcepto, decimal>();
            List<DesarrollosPyC.Com.Facturacion.Comprobantes.V33.ComprobanteConcepto> bl = new List<Com.Facturacion.Comprobantes.V33.ComprobanteConcepto>();
            foreach (var c in conceptos)
            {
                if (decimal.Round(addings.Sum(i => i.Value), 2) < decimal.Round(Importe, 2))
                {
                    ...
                    if (decimal.Round(pivote, 2) > decimal.Round(Importe, 2))
                    {
                        ...
                        Com.Facturacion.Comprobantes.V33.ComprobanteConcepto remove = null;
